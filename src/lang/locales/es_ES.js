...
module.exports = {
  ...
  /* 03.Menú */
  'menu.sodebur': 'Sodebur',
  'menu.publicaciones': 'Publicaciones',
  'menu.feed': 'Feed',
  ...
  'menu.mis-reuniones': 'Reuniones',
  'menu.configuracion': 'Configuración',
  'menu.preferencias': 'Preferencias',
  'menu.autenticacion': 'Autenticación',
  'menu.contrasena': 'Contraseña',
  'menu.home': 'Inicio',
  'menu.app': 'Inicio',
  ...
  /* Sodebur */
  'sodebur.configuracion': 'Configuracion',
  'sodebur.ecosistemas': 'Ecosistemas',
  'sodebur.repoblacion-y-calidad-de-vida': 'Repoblacion y Calidad de Vida',
  'sodebur.desarrollo-empresarial-y-empleo': 'Desarrollo Empresarial y del Empleo',
  'sodebur.transicion-verde': 'Transicion Verde',
  'sodebur.desarrollo-turistico': 'Desarrollo Turistico',
  'sodebur.territorio-inteligente': 'Territorio Inteligente y Gobernanza',
  'sodebur.deseo-votar': 'Deseo votar',
  'sodebur.deseo-publicar': 'Deseo publicar',
  'sodebur.permisos': 'Permisos',
};
